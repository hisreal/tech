...
<head>
	...
	<body class="student-dashboard-layout">
		<?php
			...
			$studentName = 'Ajiboye Isreal Oluwaseun';
			$studentClass = 'SS 2';
			$studentSection = 'Science';
		...
		<div class="main-wrapper">
			...
			<header class="student-mobile-header">
				<a class="student-mobile-brand" href="index.php" aria-label="Student dashboard">
				...
				<div class="student-sidebar-inner">
					...
					<div class="student-info-card">
						...
						<div class="student-meta-grid">
							<span><strong>Class</strong><?php echo $studentClass; ?></span>
							<span><strong>Section</strong><?php echo $studentSection; ?></span>
							<span><strong>Term</strong><?php echo $currentTerm; ?></span>
						</div>
					</div>
