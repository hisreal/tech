...
<head>
    ...
    <title>Accountant Login | <?php echo sms_e($schoolName); ?></title>
    ...
    <main class="auth-shell">
        ...
        <section class="auth-layout">
            <aside class="auth-hero" aria-label="School portal introduction">
                <span class="auth-eyebrow"><i class="fa-solid fa-calculator"></i> Accountant</span>
            ...
            <section class="auth-card-wrap" aria-label="Accountant Login form">
                <div class="auth-card">
                    <div class="auth-role-icon"><i class="fa-solid fa-calculator"></i></div>
                    <h2>Accountant Login</h2>
                    <p class="welcome">Welcome back. Enter your credentials to continue to the accountant dashboard.</p>
                    ...
                    <form action="accountant-auth.php" method="post" data-auth-form novalidate>
                        <input type="hidden" name="_token" value="<?php echo sms_e(sms_csrf_token()); ?>">
                        <div class="auth-field">
                            <label for="username-accountant">Username or Email</label>
                            <div class="auth-input">
                                <i class="fa-solid fa-user"></i>
                                <input id="username-accountant" name="username" type="text" autocomplete="username" placeholder="Enter username or email" required value="<?php echo sms_e($oldIdentifier); ?>">
                            </div>
                        ...
                        <div class="auth-field">
                            ...
                            <div class="auth-input">
                                ...
                                <input id="password-accountant" name="password" type="password" autocomplete="current-password" placeholder="Enter password" required minlength="6">
                                <button class="password-toggle" type="button" aria-label="Show password" aria-controls="password-accountant"><i class="fa-solid fa-eye"></i></button>
                            </div>
                        ...
                        <div class="auth-row">
                            ...
                            <a class="forgot" href="../forgot-password.php?portal=accountant">Forgot Password?</a>
                        </div>

                        <button class="auth-submit" type="submit"><i class="fa-solid fa-right-to-bracket"></i> Login</button>
                    </form>
                    <div class="role-pill"><i class="fa-solid fa-calculator"></i> Accountant portal</div>
